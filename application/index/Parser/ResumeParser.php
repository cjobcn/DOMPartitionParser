...
class ResumeParser {
    ...
    public $templateIDs = array(
        ...
        '17' => '/<span data-nick="res_id">(\w+|<\/span>)/',//猎聘网
        '23' => '/www\.linkedin\.com\/feed\/update|www\.linkedin\.com\/search|pv-top-card-v2-section__meta-info display-flex|www\.linkedin\.com\/in|id="ember\d+/',//linkedin  20190415简历模板
