...
class ReportParser {
    ...
    public $templateIDs = array(
        '101' => '/工作经历概览/',              //正荣推荐报告模板
        '102' => '/是否愿意异派遣/',    //阳光城推荐报告模板
        '103' => '/应聘公司/',               //中骏推荐报告模板
        '104' => '/上 海 领 程 商 务 信 息 咨 询 有 限 公 司/',               //领程推荐报告模板
        '105' => '/协骏优聘|上海优聘企业管理咨询有限公司/',               //协骏优聘推荐报告模板
        '106' => '/猎头声明：/',               //唯品会推荐报告模板
        '107' => '/机密文件/',  //慧语平安推荐报告模板
        '108' => '/Future depends on dreams/',  //越泽推荐报告模板
        '109' => '/是否接到过其他猎头公司推荐东原职位的信息/',  //东原推荐报告模板
        '110' => '/预贤咨询/',  //预贤咨询推荐报告模板
        '999' => '/.+/',  //通用推荐报告模板
    );
